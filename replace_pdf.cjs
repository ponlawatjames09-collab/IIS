            ...
            <div className="border-[1.5px] border-black flex flex-col flex-1">
              ...
              <div className="flex flex-col border-b-[1.5px] border-black">
                ...
                <div className="p-2 min-h-[50px] md:min-h-[70px]">
                  ...
                  <div className="text-red-600 text-center">{job.jobStatus === 'Pending' ? 'รอเครมอะไหล่ / Pending parts' : '-'}</div>
                </div>
              </div>
              ...
              <div className="p-2 md:p-3 border-b border-black flex gap-6 md:gap-16 justify-center">
                <label className="flex items-center gap-1.5 cursor-pointer"><input type="checkbox" checked={job.jobStatus === 'Pending'} readOnly className="border-black rounded-none" /> รออะไหล่ / Waiting For Spa(r)e Part</label>
              ...
              <div className="p-3 md:p-4 flex flex-col items-center justify-center text-center flex-1 relative">
                ...
                <p className="mb-4 md:mb-6 leading-tight">I have read and understood the service under the terms and hereby confirm that all of the above statements are true and correct</p>
